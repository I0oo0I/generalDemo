package com.kxy.demo.exception;
...
public class ReturnFormat {
	 ...
	 private static Map<String,String>messageMap = Maps.newHashMap();
	    ...
	    public static String retParam(int status,Object data) {
	    	String message = messageMap.get(String.valueOf(status));
	        OutputJson json = new OutputJson(status, message, data);
