...
public final class DateFormatUtils {
     ...
     * @throws Exception 
     */
    public static int countDays(String date) throws Exception {
     ...
     * @throws Exception 
     */
    public static int countDays(String date, String format) throws Exception {
        long t = Calendar.getInstance().getTime().getTime();
        Calendar c = Calendar.getInstance();
